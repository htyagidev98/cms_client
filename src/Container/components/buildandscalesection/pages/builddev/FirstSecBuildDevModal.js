...
const FirstSecBuildDevModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/dev/portal/update?_id=${id}`, inputData);
...
export default FirstSecBuildDevModal;