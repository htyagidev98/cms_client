...
const FirstCasesSecModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/use/applications/update?_id=${id}`, inputData);
...
export default FirstCasesSecModal;