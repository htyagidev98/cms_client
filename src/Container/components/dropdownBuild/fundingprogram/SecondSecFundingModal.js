...
const SecondSecFundingModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/build/purpose/update?_id=${id}`, inputData);
...
export default SecondSecFundingModal