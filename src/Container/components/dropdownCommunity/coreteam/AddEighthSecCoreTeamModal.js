...
const AddEighthSecCoreTeamModal = ({ show, hide, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await axios.post(`${BASE_URL}/team/cardinal/card/add`, inputData, {
                headers: {
...
export default AddEighthSecCoreTeamModal