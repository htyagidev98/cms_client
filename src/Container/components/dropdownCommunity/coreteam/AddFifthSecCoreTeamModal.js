...
const AddFifthSecCoreTeamModal = ({ show, hide, setUpdateUi }) => {
    ...
    const {  paragraph, image, title } = inputData;
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        if ( !paragraph || !image || !title) {
            toast.error('please fill the data')
        }
        try {
            const result = await axios.post(`${BASE_URL}/team/founding/card/add`, inputData, {
                headers: {
        ...
        <Modal show={show} onHide={hide} size="lg">
            ...
            <Modal.Body>
                ...
                <div className="form-group">
                    ...
                    <div className="form-group">
                        <label htmlFor="paragraph">Qualificaton</label>
                        <CKEditor
                            editor={ClassicEditor}
...
export default AddFifthSecCoreTeamModal