...
const CoreTeamThirdSec = () => {
    ...
    return (
        <>
            {
                cardData.map((curElm) => <div className="col-lg-2 col-6">
                    {
            ...
            {
                CardModal && <ThirdSecCoreTeamModal show={CardModal} setUpdateUi={setUpdateUi} hide={closeModal} objectData={objectData} />
            }
        </>
    )
}

export default CoreTeamThirdSec
