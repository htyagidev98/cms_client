...
const FifthSecCoreTeamModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/team/founding/card/update?_id=${id}`, inputData, {
                headers: {
    ...
    useEffect(() => {
        if (objectData != null) {
            ...
            setInputData((prevFormData) => ({
                ...
                qualificaton: objectData?.qualificaton || "",
...
export default FifthSecCoreTeamModal