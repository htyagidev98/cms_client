...
const SeventhSecPressKitModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/press/brand/card/update?_id=${id}`, inputData, {
                headers: {
...
export default SeventhSecPressKitModal