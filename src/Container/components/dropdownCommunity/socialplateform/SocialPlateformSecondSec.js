    ...
    return (
        <div className='text-white'>
           ...
           <div dangerouslySetInnerHTML={{ __html: cardData.title }}></div>
            ...
            {
            CardModal && <SecondSecSocialPlateformModal show={CardModal} setUpdateUi={setUpdateUi} hide={closeModal} objectData={objectData} />
           }
        </div>
    )
}

export default SocialPlateformSecondSec;