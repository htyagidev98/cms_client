...
const SecondSecUpcomingEventModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/upcoming-events/event/card/update?_id=${id}`, inputData);
...
export default SecondSecUpcomingEventModal;