...
const TestAddSecondUpcomingEventModal = ({ show, hide, setUpdateUi }) => {
    ...
    const { title, paragraph, image } = inputData;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await axios.post(`${BASE_URL}/upcoming-events/event/card/add`, inputData, {
                headers: {
...
export default TestAddSecondUpcomingEventModal