...
const ThirdSecEcosystemModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/ecosystem/imageCard/update?_id=${id}`, inputData, {
                headers: {
...
export default ThirdSecEcosystemModal