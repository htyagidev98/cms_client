...
const FirstSecUtilityModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/utility/utility/update?_id=${id}`, inputData);
...
export default FirstSecUtilityModal