...
const SecondSecUtilityModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/utility/metrics/update?_id=${id}`, inputData);
...
export default SecondSecUtilityModal