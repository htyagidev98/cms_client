...
const SixthSecUtilityModal = ({ show, hide, objectData, setUpdateUi }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const result = await axios.put(`${BASE_URL}/utility/economics/update?_id=${id}`, inputData);
...
export default SixthSecUtilityModal